      ...
      setEditData({
        ...
        billingMode:
          editableModel.billingMode === 'tiered_expr'
            ? 'tiered_expr'
            : editableModel.perRequestSubMode === 'per-resolution' ||
  ...
  const handleDelete = useCallback(
    (name: string) => {
      ...
      onChange(
        ...
        JSON.stringify(imageModelMap, null, 2)
      )
    },
    [
      modelPrice,
    ...
    (data: ModelRatioData, targetNames: string[] = [data.name]) => {
      ...
      targetNames.forEach((name) => {
        ...
        if (
          ...
          const cfg: ImageModelConfig = { billing_mode: 'per_size' }
