...
var defaultModelRatio = map[string]float64{
	...
	"gpt-image-2":                      4.0,  // $8 / 1M tokens (input)
	"o1":                               7.5,  // $15 / 1M tokens
...
var defaultCompletionRatio = map[string]float64{
	...
	"gpt-4-all":      2,
	"gpt-image-1":    8,
	"gpt-image-2":    7.5, // $30 output / $8 input ≈ 3.75x; ratio stored as completion/input = 30/4 = 7.5
}
...
var defaultImageRatio = map[string]float64{
	"gpt-image-1": 2,
	"gpt-image-2": 2, // image input tokens billed at same rate as text input
}
